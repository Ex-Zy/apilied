...
!function (e, n) {
  ...
  var r = "fullpage-wrapper",
    ...
    function s(n, t) {
      ...
      var n = e(b).prev(y);n.length || !l.loopTop && !l.continuousVertical || (n = e(y).last()), n.length && Qe(n, null, !0);
    }function ce() {
      var n = e(b).next(y);n.length || !l.loopBottom && !l.continuousVertical || (n = e(y).first()), n.length && Qe(n, null, !1);
    }function de(e, n) {
      q(0, "internal"), fe(e, n), q(Wt.scrollingSpeed, "internal");
    }function fe(e, n) {
      var t = Zn(e);"undefined" != typeof n ? jn(e, n) : t.length > 0 && Qe(t);
    }function ue(e) {
      Ue("right", e);
    }function he(e) {
      Ue("left", e);
      ...
      if (!kt.hasClass(f)) {
        Mt = !0, At = ne.height(), e(y).each(function () {
          var n = e(this).find(V),
              t = e(this).find(R);l.verticalCentered && e(this).find(I).css("height", Wn(e(this)) + "px"), e(this).css("height", Ce(e(this)) + "px"), l.scrollOverflow && (t.length ? t.each(function () {
            Pn(e(this));
          }) : Pn(e(this))), t.length > 1 && Tn(n, n.find(D));
        });var t = e(b),
            o = t.index(y);o && de(o + 1), Mt = !1, e.isFunction(l.afterResize) && n && l.afterResize.call(kt), e.isFunction(l.afterReBuild) && !n && l.afterReBuild.call(kt);
      }
    }function ve(n) {
      var t = St.hasClass(c);n ? t || (s(!1, "internal"), K(!1, "internal"), e(O).hide(), St.addClass(c), e.isFunction(l.afterResponsive) && l.afterResponsive.call(kt, n), l.responsiveSlides && wt.responsiveSlides && wt.responsiveSlides.toSections()) : t && (s(Wt.autoScrolling, "internal"), K(Wt.autoScrolling, "internal"), e(O).show(), St.removeClass(c), e.isFunction(l.afterResponsive) && l.afterResponsive.call(kt, n), l.responsiveSlides && wt.responsiveSlides && wt.responsiveSlides.toSlides());
    }function ge() {
      return { options: l, internals: { getDestinationPosition: qe, isTouch: It, c: dn, getXmovement: Dn, removeAnimation: En, getTransforms: lt, lazyLoad: nn, addAnimation: Ln, performHorizontalMove: kn, landscapeScroll: Tn, silentLandscapeScroll: rt, keepSlidesPosition: Xe, silentScroll: at, styleSlides: xe, scrollHandler: Be, getSlidesDestiny: Ge, getEventsPage: it, getMSPointer: ot, isReallyTouch: Ze, checkParentForNormalScrollElement: Fe } };
    }function me() {
      l.css3 && (l.css3 = _n()), l.scrollBar = l.scrollBar || l.hybrid, ye(), be(), ae(!0), s(l.autoScrolling, "internal");var n = e(b).find(D);n.length && (0 !== e(b).index(y) || 0 === e(b).index(y) && 0 !== n.index()) && rt(n), On(), Qn(), "complete" === t.readyState && fn(), ne.on("load", fn);
    }function Se() {
      ...
      var t = "fp_" + e + "Extension";Ft[e] = l[e + "Key"], wt[e] = "undefined" != typeof n[t] ? new n[t]() : null, wt[e] && wt[e].c(e);
    }function ye() {
      var n = kt.find(l.sectionSelector);l.anchors.length || (l.anchors = n.filter("[data-anchor]").map(function () {
        return e(this).data("anchor").toString();
      }).get()), l.navigationTooltips.length || (l.navigationTooltips = n.filter("[data-tooltip]").map(function () {
        return e(this).data("tooltip").toString();
      }).get());
    }function be() {
      kt.css({ height: "100%", position: "relative" }), kt.addClass(r), e("html").addClass(u), At = ne.height(), kt.removeClass(f), ke(), e(y).each(function (n) {
        var t = e(this),
            o = t.find(R),
            i = o.length;Te(t, n), Ie(t, n), i > 0 ? xe(t, o, i) : l.verticalCentered && Vn(t);
      ...
      var i = 100 * o,
          r = 100 / o;t.wrapAll('<div class="' + W + '" />'), t.parent().wrap('<div class="' + P + '" />'), n.find(F).css("width", i + "%"), o > 1 && (l.controlArrows && Ae(n), l.slidesNavigation && Un(n, o)), t.each(function (n) {
        e(this).css("width", r + "%"), l.verticalCentered && Vn(e(this));
      });var a = n.find(D);a.length && (0 !== e(b).index(y) || 0 === e(b).index(y) && 0 !== a.index()) ? rt(a) : t.eq(0).addClass(p);
    }function Ce(e) {
      ...
      St.append('<div id="' + M + '"><ul></ul></div>');var n = e(O);n.addClass(function () {
        ...
        var o = "";l.anchors.length && (o = l.anchors[t]);var i = '<li><a href="#' + o + '"><span></span></a>',
            r = l.navigationTooltips[t];"undefined" != typeof r && "" !== r && (i += '<div class="' + L + " " + l.navigationPosition + '">' + r + "</div>"), i += "</li>", n.find("ul").append(i);
      ...
      var t = e.attr("src");e.attr("src", t + He(t) + n);
    }function He(e) {
      return (/\?/.test(e) ? "&" : "?"
      );
    }function ze() {
      var n = e(b);n.addClass(g), l.scrollOverflowHandler.afterRender && l.scrollOverflowHandler.afterRender(n), nn(n), tn(n), l.scrollOverflowHandler.afterLoad(), e.isFunction(l.afterLoad) && l.afterLoad.call(n, n.data("anchor"), n.index(y) + 1), e.isFunction(l.afterRender) && l.afterRender.call(kt);
    }function Be() {
      var n;if ((!l.autoScrolling || l.scrollBar || ft("dragAndMove")) && !ht()) {
        var i = ft("dragAndMove") ? o.abs(wt.dragAndMove.getCurrentScroll()) : ne.scrollTop(),
            ...
            d = c === i,
            f = t.querySelectorAll(y);if (d) a = f.length - 1;else if (i) for (var u = 0; u < f.length; ++u) {
          var h = f[u];h.offsetTop <= s && (a = u);
        } else a = 0;if (Re(r) && (e(b).hasClass(g) || e(b).addClass(g).siblings().removeClass(g)), n = e(f).eq(a), !n.hasClass(p)) {
          Zt = !0;var v,
              m,
              S = e(b),
              w = S.index(y) + 1,
              ...
              C = n.data("anchor"),
              T = n.index(y) + 1,
              I = n.find(D);I.length && (m = I.data("anchor"), v = I.index()), Lt && (n.addClass(p).siblings().removeClass(p), e.isFunction(l.onLeave) && l.onLeave.call(S, w, T, x), e.isFunction(l.afterLoad) && l.afterLoad.call(n, C, T), rn(S), nn(n), tn(n), Bn(C, T - 1), l.anchors.length && (yt = C), Gn(v, m, C, T)), clearTimeout(Dt), Dt = setTimeout(function () {
            Zt = !1;
          }, 100);
      ...
      var n = e > Yt ? "down" : "up";return Yt = e, qt = e, n;
    }function Pe(e, n) {
      if (Ht.m[e]) {
        var t = "down" === e ? "bottom" : "top",
            o = "down" === e ? ce : se;if (wt.scrollHorizontally && (o = wt.scrollHorizontally.getScrollSection(e, o)), n.length > 0) {
          if (!l.scrollOverflowHandler.isScrolled(t, n)) return !0;o();
        } else o();
      }
    }function Ve(e) {
      var n = e.originalEvent;!Fe(e.target) && l.autoScrolling && Ze(n) && e.preventDefault();
    }function We(n) {
      var t = n.originalEvent,
          i = e(t.target).closest(y);if (!Fe(n.target) && Ze(t)) {
        l.autoScrolling && n.preventDefault();var r = l.scrollOverflowHandler.scrollable(i),
            a = it(t);Ut = a.y, Gt = a.x, i.find(V).length && o.abs(Nt - Gt) > o.abs(jt - Ut) ? !Ct && o.abs(Nt - Gt) > ne.outerWidth() / 100 * l.touchSensitivity && (Nt > Gt ? Ht.m.right && ue(i) : Ht.m.left && he(i)) : l.autoScrolling && Lt && o.abs(jt - Ut) > ne.height() / 100 * l.touchSensitivity && (jt > Ut ? Pe("down", r) : Ut > jt && Pe("up", r));
      }
    }function Fe(n, t) {
      ...
      var n = e.originalEvent;if (l.fitToSection && mt.stop(), Ze(n)) {
        var t = it(n);jt = t.y, Nt = t.x;
      }
    }function je(e, n) {
      ...
      var i = new Date().getTime(),
          r = e(m).hasClass(A);if (l.autoScrolling && !xt && !r) {
        t = t || n.event;var a = t.wheelDelta || -t.deltaY || -t.detail,
            s = o.max(-1, o.min(1, a)),
            c = "undefined" != typeof t.wheelDeltaX || "undefined" != typeof t.deltaX,
            d = o.abs(t.wheelDeltaX) < o.abs(t.wheelDelta) || o.abs(t.deltaX) < o.abs(t.deltaY) || !c;Et.length > 149 && Et.shift(), Et.push(o.abs(a)), l.scrollBar && (t.preventDefault ? t.preventDefault() : t.returnValue = !1);var f = e(b),
            u = l.scrollOverflowHandler.scrollable(f),
            h = i - Xt;if (Xt = i, h > 200 && (Et = []), Lt && !ut()) {
          var p = je(Et, 10),
              v = je(Et, 70),
              g = p >= v;g && d && (0 > s ? Pe("down", u) : Pe("up", u));
        }return !1;
      }l.fitToSection && mt.stop();
    }function Ue(n, t) {
      var o = "undefined" == typeof t ? e(b) : t,
          i = o.find(V);if (!(!i.length || ut() || Ct || i.find(R).length < 2)) {
        var r = Ge(n, i);Ct = !0, Tn(i, r, n);
      }
    }function Ge(e, n) {
      var t = (n.find(R).length, n.find(D)),
          o = null;if (o = "left" === e ? t.prev(R) : t.next(R), !o.length) {
        if (!l.loopHorizontal) return;o = "left" === e ? t.siblings(":last") : t.siblings(":first");
      }return o;
    }function Xe() {
      e(D).each(function () {
        rt(e(this), "internal");
      ...
      var n = e.position(),
          ...
          r = l.bigSectionsDestination;return e.outerHeight() > At ? (!o && !r || "bottom" === r) && (t = i) : (o || Mt && e.is(":last-child")) && (t = i), l.offsetSections && wt.offsetSections && (t = wt.offsetSections.getSectionPosition(o, t, e)), qt = t, t;
    }function Qe(n, t, o) {
      ...
      if (l.css3 && l.autoScrolling && !l.scrollBar) {
        var t = "translate3d(0px, -" + o.round(n.dtop) + "px, 0px)";Fn(t, !0), l.scrollingSpeed ? (clearTimeout(Bt), Bt = setTimeout(function () {
          en(n);
      ...
      if (l.lazyLoading) {
        var t,
            o = an(n);o.find("img[data-src], source[data-src], audio[data-src], iframe[data-src]").each(function () {
      ...
      var t = an(n);t.find("video, audio").each(function () {
        ...
        var n = e(this).get(0);n.hasAttribute("data-autoplay") && on(n), n.onload = function () {
      ...
      function n(e) {
        ...
        for (var n, t = "", o = 0, i = 0, r = 0; o < e.length;) {
          i = e.charCodeAt(o), 128 > i ? (t += String.fromCharCode(i), o++) : i > 191 && 224 > i ? (r = e.charCodeAt(o + 1), t += String.fromCharCode((31 & i) << 6 | 63 & r), o += 2) : (r = e.charCodeAt(o + 1), n = e.charCodeAt(o + 2), t += String.fromCharCode((15 & i) << 12 | (63 & r) << 6 | 63 & n), o += 3);
        }return t;
      }function o(e) {
        return e;
      }function i(e) {
      ...
      if (t.domain.length) {
        var e = t.domain.replace(/^(www\.)/, "").split("."),
            n = (e.shift(), e.join("."));return n.replace(/(^\.*)|(\.*$)/g, "");
      }return "";
    }function cn(e) {
      var n = sn(),
          ...
          s = "undefined" != typeof Ft[e] && Ft[e].length;if (!s && l) return !1;var c = s ? ln(Ft[e]) : "";c = c.split("_");var d = c.length > 1 && c[1].indexOf(e, c[1].length - e.length) > -1,
      ...
      var e = n.location.hash.replace("#", "").split("/"),
          ...
          o = decodeURIComponent(e[1]);t && (l.animateAnchor ? jn(t, o) : de(t, o));
    }function un() {
      if (!Zt && !l.lockAnchors) {
        var e = n.location.hash.replace("#", "").split("/"),
            t = decodeURIComponent(e[0]),
            ...
            r = "undefined" == typeof yt && "undefined" == typeof o && !Ct;t.length && (t && t !== yt && !i || r || !Ct && bt != o) && jn(t, o);
      }
    }function hn(n) {
      clearTimeout(Vt);var t = e(":focus");if (!t.is("textarea") && !t.is("input") && !t.is("select") && "true" !== t.attr("contentEditable") && "" !== t.attr("contentEditable") && l.keyboardScrolling && l.autoScrolling) {
        var o = n.which,
            i = [40, 38, 32, 33, 34];e.inArray(o, i) > -1 && n.preventDefault(), xt = n.ctrlKey, Vt = setTimeout(function () {
          xn(n);
        }, 150);
      }
    }function pn() {
      ...
      var n = e(this).closest(y);e(this).hasClass(X) ? Ht.m.left && he(n) : Ht.m.right && ue(n);
    }function wn() {
      Ot = !1, xt = !1;
    }function yn(n) {
      n.preventDefault();var t = e(this).parent().index();Qe(e(y).eq(t));
    }function bn(n) {
      n.preventDefault();var t = e(this).closest(y).find(V),
          o = t.find(R).eq(e(this).closest("li").index());Tn(t, o);
    }function xn(n) {
      var t = n.shiftKey;if (Lt || !([37, 39].indexOf(n.which) < 0)) switch (n.which) {case 38:case 33:
          Ht.k.up && se();break;case 32:
          if (t && Ht.k.up) {
            se();break;
          }case 40:case 34:
          Ht.k.down && ce();break;case 36:
          Ht.k.up && fe(1);break;case 35:
          Ht.k.down && fe(e(y).length);break;case 37:
          Ht.k.left && he();break;case 39:
          Ht.k.right && ue();break;default:
          return;}
    }function Cn(e) {
      ...
      var i = n.destinyPos;if (l.css3) {
        var r = "translate3d(-" + o.round(i.left) + "px, 0px, 0px)";Ln(e.find(F)).css(lt(r)), Rt = setTimeout(function () {
          t && In(n);
      ...
      if (On(), Tt) {
        var n = e(t.activeElement);if (!n.is("textarea") && !n.is("input") && !n.is("select")) {
          var i = ne.height();o.abs(i - _t) > 20 * o.max(_t, i) / 100 && (pe(!0), _t = i);
        }
      ...
      var n = Ce(e);if (l.paddingTop || l.paddingBottom) {
        var t = e;t.hasClass(w) || (t = e.closest(y));var o = parseInt(t.css("padding-top")) + parseInt(t.css("padding-bottom"));n = At - o;
      }return n;
    }function Fn(e, n) {
      ...
      var t = kt.find(y + '[data-anchor="' + n + '"]');return t.length || (t = e(y).eq(n - 1)), t;
    }function Yn(e, n) {
      var t = n.find(V),
          o = t.find(R + '[data-anchor="' + e + '"]');return o.length || (o = t.find(R).eq(e)), o;
    }function jn(e, n) {
      var t = Zn(e);t.length && ("undefined" == typeof n && (n = 0), e === yt || t.hasClass(p) ? Nn(t, n) : Qe(t, function () {
        Nn(t, n);
      }));
    }function Nn(e, n) {
      if ("undefined" != typeof n) {
        var t = e.find(V),
            o = Yn(n, e);o.length && Tn(t, o);
      }
    }function Un(e, n) {
      ...
      var i = "";l.anchors.length && !l.lockAnchors && (e ? ("undefined" != typeof t && (i = t), "undefined" == typeof n && (n = e), bt = n, Xn(i + "/" + n)) : "undefined" != typeof e ? (bt = n, Xn(t)) : Xn(t)), Qn();
    }function Xn(e) {
      if (l.recordHistory) location.hash = e;else if (Tt || It) n.history.replaceState(i, i, "#" + e);else {
      ...
      var n = e(b),
          ...
          o = qn(n),
          i = qn(t),
          r = String(o);t.length && (r = r + "-" + i), r = r.replace("/", "-").replace("#", "");var a = new RegExp("\\b\\s?" + h + "-[^\\s]+\\b", "g");St[0].className = St[0].className.replace(a, ""), St.addClass(h + "-" + r);
    }function _n() {
      var e,
          o = t.createElement("p"),
      ...
      var e,
          o = "";n.addEventListener ? e = "addEventListener" : (e = "attachEvent", o = "on");var r = "onwheel" in t.createElement("div") ? "wheel" : t.onmousewheel !== i ? "mousewheel" : "DOMMouseScroll";"DOMMouseScroll" == r ? t[e](o + "MozMousePixelScroll", Ne, !1) : t[e](o + r, Ne, !1);
    }function $n() {
      ...
      if (Tt || It) {
        var n = ot();l.autoScrolling && St.off("touchmove " + n.move).on("touchmove " + n.move, Ve), e(a).off("touchstart " + n.down).on("touchstart " + n.down, Ye).off("touchmove " + n.move).on("touchmove " + n.move, We);
      }
    }function tt() {
      if (Tt || It) {
        var n = ot();e(a).off("touchstart " + n.down).off("touchmove " + n.move);
      }
    }function ot() {
      var e;return e = n.PointerEvent ? { down: "pointerdown", move: "pointermove" } : { down: "MSPointerDown", move: "MSPointerMove" };
    }function it(e) {
      var n = [];return n.y = "undefined" != typeof e.pageY && (e.pageY || e.pageX) ? e.pageY : e.touches[0].pageY, n.x = "undefined" != typeof e.pageX && (e.pageY || e.pageX) ? e.pageX : e.touches[0].pageX, It && Ze(e) && l.scrollBar && (n.y = e.touches[0].pageY, n.x = e.touches[0].pageX), n;
    }function rt(e, n) {
      ...
      var n = o.round(e);if (l.css3 && l.autoScrolling && !l.scrollBar) {
        var t = "translate3d(0px, -" + n + "px, 0px)";Fn(t, !1);
      } else l.autoScrolling && !l.scrollBar ? kt.css("top", -n) : mt.scrollTop(n);
    }function lt(e) {
      return { "-webkit-transform": e, "-moz-transform": e, "-ms-transform": e, transform: e };
    }function st(e, n, t) {
      switch (n) {case "up":
          Ht[t].up = e;break;case "down":
          Ht[t].down = e;break;case "left":
          Ht[t].left = e;break;case "right":
          Ht[t].right = e;break;case "all":
          "m" == t ? ae(e) : le(e);}
    }function ct(n) {
      ...
      }), e(O + ", " + j + ", " + G).remove(), e(y).css({ height: "", "background-color": "", padding: "" }), e(R).css({ width: "" }), kt.css({ height: "", position: "", "-ms-touch-action": "", "touch-action": "" }), mt.css({ overflow: "", height: "" }), e("html").removeClass(u), St.removeClass(c), e.each(St.get(0).className.split(/\s+/), function (e, n) {
      ...
      }), mt.scrollTop(0);var n = [w, B, W];e.each(n, function (n, t) {
        e("." + t).removeClass(t);
      });
    }function ft(e) {
      return l[e] && wt[e];
      ...
      console && console[e] && console[e]("fullPage: " + n);
        ...
        Lt = !0,
        Et = [],
        Ht = {};Ht.m = { up: !0, down: !0, left: !0, right: !0 }, Ht.k = e.extend(!0, {}, Ht.m);var zt,
        Bt,
        Rt,
        Dt,
        Pt,
